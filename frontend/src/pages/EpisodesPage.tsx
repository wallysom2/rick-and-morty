    ...
    >
      <div className="p-5 flex flex-col h-full">
        <div className="flex items-start justify-between gap-3 mb-3">
          <span className="px-2.5 py-1 text-xs font-mono font-bold text-[var(--portal-cyan)] bg-[var(--space-medium)] rounded group-hover:bg-[var(--space-light)] transition-colors">
            {episode.episode}
          </span>
