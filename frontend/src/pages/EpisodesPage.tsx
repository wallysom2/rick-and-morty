    ...
    >
      <div className="p-5 flex flex-col h-full">
        <div className="flex items-start justify-between gap-3 mb-3">
          <span className="px-2.5 py-1 text-xs font-mono font-bold text-[var(--color-primary)] bg-[var(--space-medium)] rounded group-hover:bg-[var(--color-primary)]/10 transition-colors">
            {episode.episode}
          </span>
        ...
        <h3 className="text-lg font-semibold text-[var(--text-primary)] group-hover:text-[var(--color-primary)] transition-colors line-clamp-2 mb-auto">
          {episode.name}
        </h3>
      ...
      {isLoading ? (
        ...
        <div className="flex flex-col items-center justify-center py-16 sm:py-24">
          <div className="relative mb-6">
              <div className="relative inset-0 rounded-full animate-pulse"
              style={{ 
