...
export function ChatWidget() {
    ...
    const {
        ...
        setCharacter,
        sendMessage,
        // clearMessages - Não usado no novo design
    } = useChat();
    ...
    return (
        <>
            ...
            >
                {/* Header */}
                <div className="relative flex items-center justify-between p-3 border-b border-[#30363d] bg-[#161b22]/90 backdrop-blur-md">
                    {/* Avatar (Left) */}
                    ...
                    <div className="absolute left-1/2 -translate-x-1/2 flex bg-[#0d1117] p-1 rounded-lg border border-[#30363d]">
                        <button
                    ...
                    <button
                        ...
                        className="p-2 text-[#8b949e] hover:text-white hover:bg-[#21262d] rounded-md transition-colors shrink-0"
                        title="Fechar chat"
                    >
